...
section .bss
    input       resb    inputlen+1      ; provide space for '\0'
section .text
    global main
main:
push    rbp
mov     rbp, rsp
        ...
        mov     rdx, msg3len
        call    prints
        mov     rsi, input          ; print input buffer
        mov     rdx, inputlen       ; length of inputbuffer
        call    prints
...
push    rbp
mov     rbp, rsp
; rsi contains address of inputbuffer
; rdx contains length of inputbuffer
    mov     rax, 0          ; 0 = read
    mov     rdi, 1          ; 1 = stdin
    syscall
leave
